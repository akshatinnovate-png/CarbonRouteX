      ...
      el('div.grid-2', null,
        ...
        el('div.panel.panel--warn', null,
          ...
          el('div.panel-body', null, el('dl.kv', null,
            ...
            ...kv('CO₂e', fkg(a.co2, 1), a.co2 > b.co2 ? 'var(--red)' : 'var(--green)'),
            ...kv('Fleet time', dur(a.minutes), a.minutes > b.minutes ? 'var(--amber)' : 'var(--green)'),
            ...kv('Cost', money(a.cost), a.cost > b.cost ? 'var(--amber)' : 'var(--green)'),
            ...kv('Unserved', num(a.unserved), a.unserved > b.unserved ? 'var(--red)' : undefined))))),
      el('div.explain', null,
